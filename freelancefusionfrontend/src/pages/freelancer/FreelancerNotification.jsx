...
import FreelancerAllNotificationService from '../../services/FreelancerService/FreelancerAllNotificationService';
...
const FreelancerNotifications = () => {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        const data = await FreelancerAllNotificationService.FreelancerAllNotification();
