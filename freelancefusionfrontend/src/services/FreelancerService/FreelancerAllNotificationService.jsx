...
const FreelancerAllNotificationService = {
    FreelancerAllNotification(data) {
        return axiosClient.get("/freelancer-notifications/", data)
            .then(response => {
...
export default FreelancerAllNotificationService;
