...
const EmployerAllNotificationService = {
    EmployerAllNotification(data) {
        return axiosClient.get("/employer-notifications/", data)
            .then(response => {
...
export default EmployerAllNotificationService;
