...
const EmployerViewAllProjectService = {
    EmployerViewAllProject(data) {
        return axiosClient.get("/employer-projects/", data)
            .then(response => {
...
export default EmployerViewAllProjectService;
