...
const EmployerGetAllProjectCategoryService = {
    EmployerGetAllProjectCategory(data) {
        return axiosClient.get("/employer-projectcategories/", data)
            .then(response => {
...
export default EmployerGetAllProjectCategoryService;
